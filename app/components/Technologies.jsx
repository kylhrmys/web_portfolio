...
const Technologies = () => {
  ...
  return (
    <div className="overflow-hidden tech-section  flex flex-col justify-center items-center">
      <div className="container md:container lg:container flex flex-col justify-center lg:justify-start lg:items-start items-center px-5 py-12">
        <div>
          ...
          <p className="text-white quicksand-regular text-start hidden md:block leading-relaxed">
          ...
          <p className="text-white quicksand-regular text-start block md:hidden leading-relaxed">
          ...
          {technologyData.map((tech, index) => (
            ...
            >
              <Image
                src={tech.imageSrc}
                alt={tech.name}
                className="lg:w-28 lg:h-28 w-[4.8rem] h-[4.8rem] md:w-20 md:h-20 mb-2"
              />
            </motion.div>
          ))}
        </motion.div>
